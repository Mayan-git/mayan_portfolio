  ...
  return (
    <section ref={detailsRef} className="min-h-screen bg-ink text-white px-6 md:px-48 py-10">
      ...
      {project.images?.length === 0 && (
        <div className="fade-up-item mb-16 rounded-xl overflow-hidden aspect-[16/9] max-h-[500px] w-full">
          <ProjectVisualFallback title={project.title} tagline={project.tagline} tech={project.tech} />
        </div>
      )}
      ...
      <div className="relative flex justify-center py-8 fade-up-item">
        <div className="text-center">
          ...
          <a
            href="mailto:mayanprajapati14@gmail.com"
