    ...
    <section ref={sectionRef} id="contact" className="bg-cream py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 w-full">
        <div className="rounded-3xl bg-ink text-light p-8 sm:p-12 md:p-16 lg:p-20 border border-elevated-dark">
          ...
          <div className="card-elevated max-w-2xl space-y-6 p-6 sm:p-8 rounded-2xl mx-auto bg-surface border border-white/[0.04]">
          ...
          <div className="mt-16 md:mt-24 text-center px-4 sm:px-6 overflow-hidden">
            ...
            <button
              ...
              data-cursor="copy"
              onClick={() => {
                navigator.clipboard.writeText('mayanprajapati14@gmail.com');
            ...
            <a
              href="tel:+918791539492"
              data-cursor="copy"
              className="mt-6 inline-flex items-center gap-2 font-mono text-sm sm:text-base text-warm hover:text-forest-light transition-colors duration-300"
            >
              +91 87915 39492
            </a>
          </div>
