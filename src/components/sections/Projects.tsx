...
import ProjectVisualFallback from '@/components/project/ProjectVisualFallback';
        ...
        {projects.map((project, index) => (
          ...
          >
            <div className="p-3 pb-0">
              ...
              >
                {project.hoverImage || project.images[0] ? (
                  <Image
...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    getAllProjects().slice(0, 4).forEach((project) => {
      const url = project.hoverImage || project.images[0];
      if (!url) return;
        ...
        <div className="flex flex-col w-full">
          {projects.map((project, index) => (
            <Link
              ...
              onMouseEnter={(e) => handleRowMouseEnter(e, project.hoverImage || project.images[0] || project.slug, index)}
          ...
          >
            ...
            >
              ...
              {projects.map((project) => {
                ...
                const isActive = hoveredImage === (imgUrl || project.slug);
                return (
                  <div
                    key={project.id}
