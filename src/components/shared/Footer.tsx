      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 mb-10 md:mb-12">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 sm:gap-4 text-warm text-xs sm:text-sm font-sans font-medium uppercase tracking-wide">
              <AnimatedLink>
                <a href="https://www.linkedin.com/in/mayan-prajapati" target="_blank" rel="noopener noreferrer">
                  Linkedin
                </a>
              </AnimatedLink>
              <AnimatedLink>
                <a href="https://www.instagram.com/lg_mayan/" target="_blank" rel="noopener noreferrer">
                  Instagram
                </a>
              </AnimatedLink>
              <AnimatedLink>
                <a href="https://github.com/Mayan-git" target="_blank" rel="noopener noreferrer">
                  Github
                </a>
              </AnimatedLink>
            </ul>
