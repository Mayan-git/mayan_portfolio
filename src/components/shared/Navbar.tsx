      ...
      >
        ...
        >
          ...
          <div className="flex gap-6 justify-start">
            {[
              { label: 'GitHub', href: 'https://github.com/Mayan-git' },
              { label: 'LinkedIn', href: 'https://www.linkedin.com/in/mayan-prajapati' },
              { label: 'Instagram', href: 'https://www.instagram.com/lg_mayan/' },
            ].map((s) => (
              <a
                key={s.label}
                href={s.href}
