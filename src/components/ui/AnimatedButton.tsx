  ...
  return (
    <div ref={containerRef} className="inline-block p-8 -m-8 pointer-events-auto">
      <Component
        ...
        disabled={disabled}
        className={`relative text-xs md:text-sm outline-none overflow-hidden h-10 md:h-12 px-4 sm:px-6 md:px-8 rounded-full ${bgColor} ${textColor} ${borderColor} ${variant === 'primary' ? 'btn-glow-primary' : ''} group cursor-pointer font-medium inline-block transition-shadow duration-300 ${className}`}
